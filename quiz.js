            ...
            var makeTeamClickHandler = function(team) {
                return function() {
                    if (team !== -1) {
                        ...
                        // highlight scores green of wining team
                        if (team == 0 && scores[team][0] > scores[1][0]) {
                            scores[team][1].style.background = "green"
                            scores[1][1].style.background = "none"
                        }
                        if (team == 1 && scores[team][0] > scores[0][0]) {
                            scores[team][1].style.background = "green"
                            scores[0][1].style.background = "none"
                        }
